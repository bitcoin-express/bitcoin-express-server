...
exports.createPaymentRequest = function (req, res) {
  var { merchant_data } = req.body;
  var account = req.params._account,
  ...
  // TODO: uuid should be generated by the database to prevent collision - or maybe we can use _id?
  ...
  promise.then((finished) => {
    ...
    db.insert('transactions', data).then((records) => {
