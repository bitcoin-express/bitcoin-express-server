...
module.exports = {
  ...
  _system_required_keys: [ 'server.db.replica_set', 'server.db.user', 'server.db.password', 'server.db.scheme', 'server.db.address', 'server.db.name', 'server.api.endpoint_url', 'server.api.endpoint_path',
